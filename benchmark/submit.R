...
tab = summarizeExperiments(by = c("job.id", "algorithm", "problem", "initialization", "mu", "lambda", "maxeval", "filter.method", "learner"))
...
submitJobs(tosubmit$job.id[1:10], resources = list(
