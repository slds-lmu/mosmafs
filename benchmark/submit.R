...
experiments = list(
	...
	OIHFiFmS_featsel_only = data.table(algorithm = "mbo_multicrit", filter = "custom", surrogate = "randomForest", infill = "cb", propose.points = 15L, tune.hyperparams = FALSE)
	)
...
experiment = "OIHFiFmS_featsel_only"
