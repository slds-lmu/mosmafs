...
# saveOMLConfig(apikey = "44cbe516b92c80b010115126d74afe04")

# tocreate = c(41082, 300, 1468)

# for (id in tocreate) {

# 	OMLtask = getOMLDataSet(tocreate[[3]])

# 	data = OMLtask$data
# 	data = setDT(data)[Class %in% c(1, 2), ]
# 	data$Class = factor(data$Class, levels = c(1, 2))

# 	dsc = "Binarized version of the cnae-9 dataset (see version 1). Only instances with class labels 1 and 2 from the original dataset are considered."

# 	# Create the description object
# 	desc = makeOMLDataSetDescription(name = "cnae-9",
# 	  description = dsc,
# 	  url = "https://www.openml.org/d/1468",
